...
function buildNativePlayerToggle() {
  ...
  // PHASE 1 NATIVE UI (Beta) : bouton qui lance la nouvelle Activity Compose
  if (window.AndroidBridge && typeof window.AndroidBridge.openNativeUi === 'function') {
    ...
    nativeSection.innerHTML =
      ...
      '</div>' +
      '<div class="setting-row">' +
        '<span class="setting-help" style="font-size:12px;color:#888">Nouvelle UI 100% native Jetpack Compose en construction. Phase 1 = écran Home uniquement. Les autres écrans retombent sur cette version WebView. Appuyez sur RETOUR pour revenir ici.</span>' +
      '</div>';
